...
$canOrder	= $user->authorise('core.edit.state', 'com_joomtube');
$saveOrder	= $listOrder == 'a.ordering';
?>

<form action="<?php echo JRoute::_('index.php?option=com_joomtube&view=items'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		...
		<?php foreach ($this->items as $i => $item) :
			...
			$canCreate	= $user->authorise('core.create',		'com_joomtube');
			$canEdit	= $user->authorise('core.edit',			'com_joomtube');
			$canCheckin	= $user->authorise('core.manage',		'com_joomtube');
			$canChange	= $user->authorise('core.edit.state',	'com_joomtube');
			?>
